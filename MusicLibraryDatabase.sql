...
VALUES
    ...
    ('Guillaume Jaulen', 'Paris, France',1003), /*DJ Greem*/
	('Sylvain Richard', 'Nantes, France', 1003), /*20syl*/
	('Thomas Le Vexier', 'Nantes, France', 1003), /*DJ Atom*/
	...
	('Melissa Jefferson', 'Detroit, Michigan',1011), /*Lizzo*/
	...
	('Tyler Gregory Okonma', 'California', 1015), /*Tyler The Creator*/
	('Dion Marquise Hayes', 'Detroit, Michigan', 1015),
	('Erica Abi Wright', 'Dallas, Texas', 1025), /*Erykah Badu*/
	('Marvin Gaye', 'Washignton, DC', 1026),
	('Rick James', 'Buffalo, New York', 1026),
	('Damario McCullough', 'Flint, Michigan', 1028), /*Rio Da Yung OG*/
	('Lucki Camel Jr.', 'Chicago, Illinois',1024), /*Lucki*/
	('Marcellus Register', 'Detroit, Michigan', 1024),
	('André Benjamin', 'Atlanta, Georgia',  1037), /*Andre 3000*/
	...
	('Durk Banks', 'Chicago,Illinois', 1033), /*Lil Durk*/
	('Christopher Wood', 'Columbia, Maryland',1034), /*Brent Faiyaz*/
	('Kendrick Lamar', 'Compton, Cali',1013),
	('Otis Jackson', 'Oxnard, Cal', 1035),
	('Pierre Forestier', 'France', 1003), /*DJ pFeL*/
	('Antwan Patton', 'Savannah, Georgia', 1029), /*Big Boi*/
	('Destin Route', 'Atlanta, Georgia', 1033); /*JID*/
	go
